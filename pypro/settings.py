...
# DEBUG is boolean. Need the param 'cast' to translate correctly.
...
INSTALLED_APPS = [
    ...
    'pypro.turmas.apps.TurmasConfig',
    'ordered_model',
    #'base',
]
...
if SENTRY_DNS:
    sentry_sdk.init(
    dsn=SENTRY_DNS,integrations=[DjangoIntegration()],traces_sample_rate=1.0,send_default_pii=True)